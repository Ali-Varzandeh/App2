...
INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('Kids & Baby','Boys T-Shirt', 'Distressed Logo T-Shirt , Match the vintage-like aesthetic with his favourite distressed denim, Distressed Logo T-Shirt, 100% Cotton');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('Kids & Baby','BABY GIRLS ROMPERS', 'BABY GIRLS ROMPERS, aymarket check romper from BURBERRY KIDS featuring Haymarket check pattern, band collar, long sleeves, 
front button placket & concealed press-stud fastening, 100% Cotton');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('Home & Kitchen', 'Coffee Machine','The Barista Express Coffee Machine, aH40cm x W33cm x D31cm approx.UK plugCapacity: 2L approx. water tank with integrated filtration; 
480ml approx. stainless steel milk jug');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('Home & Kitchen','Bathroom decor', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('MENS SHIRT', 'Shirt','Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('WOMENS TOPS', 'TOPS','Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('Kids & Baby','BOY HAT', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

INSERT INTO CATEGORIES (CATEGORY_TITLE, CATEGORY_SUB, CATEGORY_DESCRIPTION)
VALUES ('Kids & Baby','GIRL Top', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');
...
These notable features include a fur trim to the hood, logo patch and reflective trim to the chest and pockets, Exterior pockets
Hooded neck
Zip fastening with button placket
Regular fit
Dry clean
Made in Canada.
85% Polyester
...
takes less than a minute. Equipped with a Thermacoil heating system and powerful 15 bar pressure system, 
the machine offers espresso in both single and double shots, and the option to make two cups of coffee at once, 
...
INSERT INTO ADDRESSES (LINE1, LINE2, LINE3, POSTCODE)
VALUES ('12 THOPSON2345', '37 SEAYMOUR GROVE  1BC', '18 SATN ANNS 676F5 ', '1676F5 ');


INSERT INTO USERS ( USER_NAME, FIRST_NAME, LAST_NAME, PASSWORD, TEL, EMAIL, ADDRESS_ID, IS_ADMIN )
VALUES ('Ali007','Ali', 'Varzandeh','007','044764299742457754', 'A.Varzandeh@gmail.com', 1, 1);
...
VALUES ('MILANO','+44 7526707423790011');


INSERT INTO ORDERS (SHIPPING_DATE, USER_ID  )
VALUES ('2020-03-15 13:10:50', 1);


INSERT INTO PRODUCTS_BASKETS ( BASKET_ID, PRODUCT_ID )
VALUES (1,1);
