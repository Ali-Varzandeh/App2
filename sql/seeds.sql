...
-- VALUES (' Womens CLOTHING', 'Midi Dress, Mushrooms, botanicals and polka dots, Autumn Print Pussybow Midi Dress, 100% Silk ');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES ('Distressed Logo T-Shirt', 'Match the vintage-like aesthetic with his favourite distressed denim, Distressed Logo T-Shirt, 100% Cotton');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES ('BABY GIRLS ROMPERS', 'aymarket check romper from BURBERRY KIDS featuring Haymarket check pattern, band collar, long sleeves, 
-- front button placket and concealed press-stud fastening, 100% Cotton');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES ('Home & Kitchen', 'The Barista Express Coffee Machine, aH40cm x W33cm x D31cm approx.UK plugCapacity: 2L approx. water tank with integrated filtration; 
-- 480ml approx. stainless steel milk jug');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES (' Kitchen', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
...
-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES (' MENS SHIRT', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
-- The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
-- The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES (' WOMENS TOPS', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
-- The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
-- The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES (' BOY HAT', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
-- The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
-- The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');

-- INSERT INTO CATEGORIES ( CATEGORY_TITLE, CATEGORY_DESCRIPTION)
-- VALUES (' GIRL SCARF', 'Freshen up your bathroom decor with this eye-catching ombre ‘Stone’ bath mat from Abyss & Habidecor. 
-- The tonal colour palette gives the illusion of a round stone and will add a thoroughly contemporary look to any bathroom. 
-- The 100% combed cotton rich fibres create extra softness and absorbency., 100% Cotton');
